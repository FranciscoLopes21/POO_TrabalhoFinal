...
void MPoker::Run() {
    ...
    if(getEstado() == ON){ //Se maquina estiver ON
            if(getUserAtual() == nullptr){ //Se maquina estiver livre
                ...
                setTemperaturaSensor(temp += 0.055) ; //Aumenta 0.055 a temperatura
                cout << "Temperatura aumentou " << 0.055 << endl;
                ...
                temp = getTemperaturaSensor();
                setTemperaturaSensor(temp += 0.13) ; //Aumenta 0.13 a temperatura
                cout << "Temperatura aumentou " << 0.13 << endl;
                if(getTemperaturaSensor() >= 35.00){ //Se temperatura foi maior ou igual a 35.00
        ...
        temp = getTemperaturaSensor();
        setTemperaturaSensor(temp - 0.57);  //Arrefecimento 0.57
        cout << "Temperatura diminuida " << 0.57 << endl;
        ...
        temp = getTemperaturaSensor();
        setTemperaturaSensor(temp - 0.75);  //Arrefecimento 0.75
