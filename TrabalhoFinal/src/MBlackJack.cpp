...
void MBlackJack::Run() {
    ...
    if(getEstado() == ON){ //Se maquina estiver ON
            if(getUserAtual() == nullptr){ //Se maquina estiver livre
                ...
                setTemperaturaSensor(temp += 0.035) ; //Aumenta 0.035 a temperatura
                cout << "Temperatura aumentou " << 0.035 << endl;
        ...
        temp = getTemperaturaSensor();
        setTemperaturaSensor(temp - 0.45);  //Arrefecimento 0.50
        cout << "Temperatura diminuida " << 0.45 << endl;
        ...
        temp = getTemperaturaSensor();
        setTemperaturaSensor(temp - 0.73);  //Arrefecimento 0.73
