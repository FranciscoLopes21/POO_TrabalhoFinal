...
void MRoleta::Run() {
    ...
    if(getEstado() == ON){ //Se maquina estiver ON
            if(getUserAtual() == nullptr){ //Se maquina estiver livre
                ...
                setTemperaturaSensor(temp += 0.038) ; //Aumenta 0.038 a temperatura
                cout << "Temperatura aumentou " << 0.038 << endl;
                ...
                temp = getTemperaturaSensor();
                setTemperaturaSensor(temp += 0.14) ; //Aumenta 0.14 a temperatura
                cout << "Temperatura aumentou " << 0.14 << endl;
                if(getTemperaturaSensor() >= 35.00){ //Se temperatura foi maior ou igual a 35.00
        ...
        temp = getTemperaturaSensor();
        setTemperaturaSensor(temp - 0.53);  //Arrefecimento 0.53
        cout << "Temperatura diminuida " << 0.53 << endl;
        ...
        temp = getTemperaturaSensor();
        setTemperaturaSensor(temp - 0.80);  //Arrefecimento 0.80
